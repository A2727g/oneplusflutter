...
//
//     final addTicketPage = addTicketPageFromJson(jsonString);

import 'dart:convert';

AddTicketPage addTicketPageFromJson(String str) => AddTicketPage.fromJson(json.decode(str));

String addTicketPageToJson(AddTicketPage data) => json.encode(data.toJson());
...
class AddTicketPage {
  ...
  factory AddTicketPage.fromJson(Map<String, dynamic> json) => AddTicketPage(
